                                ...
                                return (
                                    <div className="eachItem" key={elem.id}>
                                        ...
                                        <div className="todo-btn">
                                            <i className="far fa-plus edit-btn" title="Edit Item" onClick={() => editItem(elem.id)}></i>
                                            <i className="far fa-plus delete-btn" title="Delete Item" onClick={() => deleteItem(elem.id)}></i>
                                        </div>
                                    </div>
                                )
                            })
